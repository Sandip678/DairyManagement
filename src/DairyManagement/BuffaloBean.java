...
public class BuffaloBean {
    ...
    // Constructor
    public BuffaloBean(int id, String category, String color, String weight, String batch, String milkQuantity, String pregnancyPeriod, byte[] photo) {
        this.id = id;
