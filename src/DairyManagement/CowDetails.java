...
//----------------Image For Background-------------------------------------------------------
        ...
        ImageIcon backIcon = new ImageIcon(getClass().getResource("/images/backcow.png"));
...
//---------------Heading------------------------------------------------------------------------
        ...
        JLabel h1Label = new JLabel("Dairy Form - Cows Details");
...
//---------------Heading Shadow------------------------------------------------------------------
        ...
        JLabel h1ShodoLabel = new JLabel("Dairy Form - Cows Details");
...
//------------period - label and field--------------------------------------------------------------
        ...
        JLabel prePeriodLabel = new JLabel("Pregnancy Periods for Cow :");
        prePeriodLabel.setBounds(50,285,250,25);
        prePeriodLabel.setFont(new Font("Serif",Font.BOLD,20));
        imageLabel.add(prePeriodLabel);
...
//---------Photo Area-insert photo----------------------------------------------------------------
        ...
        JLabel photoLabel = new JLabel("Photo/Cow Image");
...
//-------------------Search - label and field------------------------------------------------------
        ...
        JLabel searchLabel = new JLabel("Search Cow (ID No.) :");
        searchLabel.setBounds(400, 320, 350, 25);
        ...
        searchField.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                //ArrayList<CowBean> al = null;
                ArrayList<CowBean> al = new ArrayList<>();
                ...
                try{
                    ...
                    String qry = "SELECT * FROM cow WHERE id LIKE '%" + valu + "%'";
                    ...
                    while(rs.next()){
                        ...
                        cowBean = new CowBean(rs.getInt(1), rs.getString("category"), rs.getString("color"),
                ...
                if (batchField.getText().isEmpty() ||
                    ...
                    try {
                        ...
                        if (photopath != null && !photopath.isEmpty()) {
                            ...
                            qry = "INSERT INTO cow (batch, category, color, weight, milk_quantity, pregnancy_period, image) VALUES(?,?,?,?,?,?,?)";
                            ...
                            qry = "INSERT INTO cow (batch, category, color, weight, milk_quantity, pregnancy_period) VALUES(?,?,?,?,?,?)";
                            statement = conn.prepareStatement(qry);
                            statement.setString(1, batchField.getText());
                            statement.setString(2, categoryField.getText());
                            statement.setString(3, colorField.getText());
                        ...
                        if (res >= 1) {
                            JOptionPane.showMessageDialog(null, "Cow details saved successfully.");
                        } else {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (photopath != null && !photopath.isEmpty()) {
                    try {
                        ...
                        qry = "UPDATE cow SET batch=?, category=?, color=?, weight=?, milk_quantity=?, pregnancy_period=?, image=? WHERE id=?";
                        Connection conn = dbConnection.getConnection();
                        statement = conn.prepareStatement(qry);
                        statement.setString(1, batchField.getText());
                        statement.setString(2, categoryField.getText());
                        ...
                        if (res >= 1) {
                            JOptionPane.showMessageDialog(null, "Cow Detail updated successfully.");
                        } else {
                    ...
                    try {
                        qry = "UPDATE cow SET batch=?, category=?, color=?, weight=?, milk_quantity=?, pregnancy_period=? WHERE id=?";
                        Connection conn = dbConnection.getConnection();
                        statement = conn.prepareStatement(qry);
                        statement.setString(1, batchField.getText());
                        statement.setString(2, categoryField.getText());
        ...
        delete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(idField.getText().equals("")) {
                    ...
                    try {
                        String qry = "delete from cow where id=?";
                        DatabaseConnection dbConnection = new DatabaseConnection();
                        Connection conn = dbConnection.getConnection();
                        ...
                        if(res >= 1) {
                            JOptionPane.showMessageDialog(null, "Cow detail deleted successfully.");
                        } else {
...
//---------------Arraylist for Data retrive (methods)----------------------------------------------------
    ...
    public ArrayList<CowBean> retriveData(){
        //ArrayList<CowBean> al = null;
        ArrayList<CowBean> al = new ArrayList<>();
        ...
        try{
            ...
            while(rs.next()){
                ...
                cowBean = new CowBean(rs.getInt(1), rs.getString("category"),
...
//----------Data Fill in table method--------------------------------------------------------------
    ...
    public void fillTable(){
        ...
        ArrayList<CowBean>  al= retriveData();
        DefaultTableModel model =(DefaultTableModel)jTable1.getModel();
        model.setRowCount(0);
        Object [] row = new Object[8];
        for(int i = 0; i < al.size(); i++ ){
